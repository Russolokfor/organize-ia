...
import { useFinancial, FinancialProvider } from '@/components/financial/FinancialProvider'
...
const TransactionModal = dynamic(() => import('@/components/financial/FinancialForms').then(mod => mod.TransactionModal), { ssr: false })
const BudgetModal = dynamic(() => import('@/components/financial/FinancialForms').then(mod => mod.BudgetModal), { ssr: false })
const GoalModal = dynamic(() => import('@/components/financial/FinancialForms').then(mod => mod.GoalModal), { ssr: false })
const StatementUploadModal = dynamic(() => import('@/components/financial/StatementUploadModal').then(mod => mod.StatementUploadModal), { ssr: false })

export function FinancialPortalClient({ initialData }: { initialData?: any }) {
  return (
    <FinancialProvider initialData={initialData}>
      <FinancialPortalInner />
    </FinancialProvider>
  )
}

function FinancialPortalInner() {
